...
const actionGroup = {
    ...mockData_1.mockActionGroup,
    hostInstances: [{ status: 'ONLINE', isInitializing: false }],
    httpHosts: [],
    metadata: {
        ...mockData_1.mockActionGroupMetadata,
        accesses: [],
    },
};
const action = {
    ...mockData_1.mockAction,
    hostInstances: [{ status: 'ONLINE' }],
    httpHosts: [],
    schedules: [],
    metadata: {
        ...mockData_1.mockActionMetadata,
        accesses: [],
    },
};
describe('reconstructActionGroups', () => {
    const testGroups = {
        ...
        hasAccess: {
            ...
            metadata: {
                ...actionGroup.metadata,
                availability: 'GROUPS',
                accesses: [mockData_1.mockActionGroupAccess],
            },
        },
    };
    const testActions = {
        ...
        hasAccess: {
            ...
            metadata: {
                ...action.metadata,
                availability: 'GROUPS',
                accesses: [mockData_1.mockActionAccess],
            },
        },
    };
    test('returns correct groups without a slugPrefix', () => {
        const { groups, actions, groupBreadcrumbs } = (0, actions_1.reconstructActionGroups)({
    ...
    test("breadcrumbs don't include groups with common substrings", () => {
        const { groupBreadcrumbs } = (0, actions_1.reconstructActionGroups)({
    ...
    test('excludes nested action with no access', () => {
        const { groups } = (0, actions_1.reconstructActionGroups)({
    ...
    test('excludes all groups and actions with undefined access within a top-level group with no access', () => {
        const { groups, actions } = (0, actions_1.reconstructActionGroups)({
            slugPrefix: 'included',
            actionGroups: [
                {
                    ...testGroups['noAccess'],
